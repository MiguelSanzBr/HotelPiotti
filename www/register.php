...
<body
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-96 bg-opacity-30 backdrop-blur-md">
        ...
        <form action="process_register.php" method="POST">
            ...
            <div class="mb-6">
                <!-- Input de senha de usuario, name = password -->
                <label for="password" class="block text-sm font-medium text-gray-900">Senha</label>
                <input type="password" id="password" name="password"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    placeholder="123joao" required>
            </div>
            <div class="text-center">
                <!-- Link para pagina de Login -->
                <a href="login.php" class="font-bold text-indigo-600 transition duration-300 hover:text-indigo-800">Fazer login</a>
                <p class="my-5">ou</p>
            </div>
            <div class="mt-6">
